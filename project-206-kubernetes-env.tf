...
variable "key-name" {
  default = "Zabkey"   # change here
}

locals {
  name = "zabraham"   # change here, optional
}
...
output "master_public_ip_add" {
  value = "http://${aws_instance.master.public_ip}:30002/"
}
output "master_public_ip_result" {
  value = "http://${aws_instance.master.public_ip}:30001/"
}
